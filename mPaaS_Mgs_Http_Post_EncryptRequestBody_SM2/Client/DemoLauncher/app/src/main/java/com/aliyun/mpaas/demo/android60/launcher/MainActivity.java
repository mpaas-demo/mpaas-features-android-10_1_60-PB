    ...
    public void button1Clicked(View view)
    {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                PathMpaasMgsHttpPostEncryptrequestbodySm2PostReq req = new PathMpaasMgsHttpPostEncryptrequestbodySm2PostReq();
                req._requestBody = user;
                String result = client.pathMpaasMgsHttpPostEncryptrequestbodySm2Post(req);
