...
import com.aliyun.mpaas.demo.android60.launcher.request.PathMpaasMgsHttpPostFormPostReq;
    ...
    public void button1Clicked(View view)
    {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                PathMpaasMgsHttpPostFormPostReq req = new PathMpaasMgsHttpPostFormPostReq();
                req._requestBody = user;
                String result = client.pathMpaasMgsHttpPostFormPost(req);
