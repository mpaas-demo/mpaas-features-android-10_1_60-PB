    ...
    public void button1Clicked(View view)
    {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                PathMpaasMgsHttpPostEncryptrequestbodyEccPostReq req = new PathMpaasMgsHttpPostEncryptrequestbodyEccPostReq();
                req._requestBody = user;
                String result = client.pathMpaasMgsHttpPostEncryptrequestbodyEccPost(req);
